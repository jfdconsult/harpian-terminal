...
const HPC22: Fund = {
  ...
  engineArchitecture: [
    { k: "Attack engine", v: "HC-US 3.1 CORE22+ — Sector-adaptive momentum (S&P 500, 2 stocks/sector)" },
    { k: "Attack selection", v: "DEMA-cascade smoothed ROC · Tau calibrated per sector (28-189 days)" },
    { k: "Defense engine", v: "HSA v6 — Pillar-based protection (SHARED across all portfolios)" },
    { k: "Layer 1 (defense)", v: "Pillar temperature — turbulence × 0,40 + trend break × 0,35 + jerk × 0,25" },
    { k: "Layer 2 (defense)", v: "Systemic gate — Cross-correlation (0,55 → 0,75) → g factor" },
    { k: "Layer 3 (defense)", v: "Re-entry monitor — EMA 20 + velocity + gradual sizing" },
    { k: "Regime", v: "Binary BULL / BEAR — StormGuard-Armor (SGA ≥ 0 = BULL, SGA < 0 = BEAR)" },
    { k: "Balancing", v: "Regime-based switching (SHARED) — attack in BULL, defense in BEAR" },
    { k: "Rebalancing", v: "Monthly, systematic" },
  ],
  purchaseSteps: [
...
const HPC11: Fund = {
  ...
  engineArchitecture: [
    { k: "Attack engine", v: "HC-US I.G. — Conservative Investment Grade (S&P 500, I.G. universe)" },
    { k: "Attack selection", v: "DEMA-cascade smoothed ROC · Tau calibrated per sector" },
    { k: "Defense engine", v: "HSA v6 — Pillar-based protection (SHARED across all portfolios)" },
    { k: "Layer 1 (defense)", v: "Pillar temperature — turbulence × 0,40 + trend break × 0,35 + jerk × 0,25" },
    { k: "Layer 2 (defense)", v: "Systemic gate — Cross-correlation (0,55 → 0,75) → g factor" },
    { k: "Layer 3 (defense)", v: "Re-entry monitor — EMA 20 + velocity + gradual sizing" },
    { k: "Regime", v: "Binary BULL / BEAR — StormGuard-Armor (SGA ≥ 0 = BULL, SGA < 0 = BEAR)" },
    { k: "Balancing", v: "Regime-based switching (SHARED) — attack in BULL, defense in BEAR" },
    { k: "Special defense", v: "Defensive ETFs + 60/40 cushion (conservative)" },
    { k: "Rebalancing", v: "Monthly, systematic" },
  ],
  purchaseSteps: [
...
const LCORE22: Fund = {
  ...
  engineArchitecture: [
    { k: "Attack engine", v: "AlphaDroid CORE22+ MAX — Exact replica of Diogo's momentum engine (portfolio 829)" },
    { k: "Attack selection", v: "DEMA-cascade T13 (short Tau) — smoothed ROC per sector, top-1 per sleeve" },
    { k: "Attack universe", v: "22 sleeves × 12 stocks = 264 stocks · 11 GICS + Bonds + BigTech" },
    { k: "Tau per sector", v: "Tech 28-36d · Comm 55d · ConsDisc 55d · Fin 55d · Health 103-189d · Ind 55d · Mat 55d · RE 55d · Energy 55d · Util 55d" },
    { k: "Defense engine", v: "HSA v6 — Pillar-based protection (SHARED across all portfolios)" },
    { k: "Layer 1 (defense)", v: "Pillar temperature — turbulence × 0,40 + trend break × 0,35 + jerk × 0,25" },
    { k: "Layer 2 (defense)", v: "Systemic gate — Cross-correlation (0,55 → 0,75) → g factor" },
    { k: "Layer 3 (defense)", v: "Re-entry monitor — EMA 20 + velocity + gradual sizing" },
    { k: "Regime", v: "StormGuard-Armor (SGA ≥ 0 = BULL, SGA < 0 = BEAR) — 77% bull / 23% bear historically" },
    { k: "Defense activated", v: "Nuclear Defensive: bonds 58%, health 21%, energy 20%" },
    { k: "Balancing", v: "Regime-based switching (SHARED) — attack in BULL, defense in BEAR" },
    { k: "Rebalancing", v: "Monthly, systematic, Tau calibrated per sector" },
  ],
  purchaseSteps: [
