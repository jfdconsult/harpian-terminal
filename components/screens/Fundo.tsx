...
const TR = {
  ...
  riskAnalysisHpc11: { pt: "Análise de risco para o HPC22", en: "Risk analysis for HPC22" },
  ...
  crisisDefenseTitle: { pt: "Defesa em crises para o HPC22", en: "Crisis defense for HPC22" },
